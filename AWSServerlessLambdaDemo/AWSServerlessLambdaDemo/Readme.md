...
WORKDIR /src
COPY ["AWSServerlessLambdaDemo.csproj", "AWSServerlessLambdaDemo/"]
RUN dotnet restore "AWSServerlessLambdaDemo/AWSServerlessLambdaDemo.csproj"

WORKDIR "/src/AWSServerlessLambdaDemo"
COPY . .
RUN dotnet build "AWSServerlessLambdaDemo.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "AWSServerlessLambdaDemo.csproj" \
...
Execute unit tests
```
    cd "AWSServerlessLambdaDemo/test/AWSServerlessLambdaDemo.Tests"
    dotnet test
```

Deploy application
```
    cd "AWSServerlessLambdaDemo/src/AWSServerlessLambdaDemo"
